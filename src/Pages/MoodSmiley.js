    ...
    return (
        <>
            <Box sx={{ display: "flex", justifyContent: "space-around", height: "100%", gap: "1em", padding: "0.5em" }}>
                <Box id="good" className="bg-primary" sx={{flexGrow: "1", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center"}} onClick={(div) => selectMood(div)}>
                ...
                <Box id="neutral" className="bg-primary" sx={{flexGrow: "1", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center"}} onClick={(div) => selectMood(div)}>
                ...
                <Box id="bad" className="bg-primary" sx={{flexGrow: "1", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center"}} onClick={(div) => selectMood(div)}>
